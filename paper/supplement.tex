...
the lower right of the figure. Table~S1 provides a list of each topic's
...
between the topic correlations from each of the $n$\textsuperscript{th} top-weighted principal components
